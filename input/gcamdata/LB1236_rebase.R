...
# import data
elecS_horizontal_to_vertical_map <- read_csv("./inst/extdata/gcam-china/elecS_horizontal_to_vertical_map.csv", comment = "#")
L1234.out_EJ_grid_elec_F <- read_csv("./outputs/L1234.out_EJ_grid_elec_F_CHINA.csv", comment = "#") %>%
  rename(grid_region = grid.region)
L1235.grid_elec_supply_CHINA <- read_csv("./outputs/L1235.grid_elec_supply_CHINA.csv", comment = "#")
L1235.elecS_demand_fraction_CHINA <- read_csv("./outputs/L1235.elecS_demand_fraction_CHINA.csv", comment = "#")
L1235.elecS_horizontal_vertical_CHINA <- read_csv("./outputs/L1235.elecS_horizontal_vertical_CHINA.csv", comment = "#")
