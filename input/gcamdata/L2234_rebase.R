...
A23.elecS_sector <- read_csv("./inst/extdata/gcam-china/A23.elecS_sector.csv", comment = "#")
A23.elecS_metainfo <- read_csv("./inst/extdata/gcam-china/A23.elecS_metainfo.csv", comment = "#")
A23.elecS_subsector_logit <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_logit.csv", comment = "#")
A23.elecS_subsector_shrwt <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt.csv", comment = "#")
A23.elecS_subsector_shrwt_interp <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt_interp.csv", comment = "#")
A23.elecS_subsector_shrwt_interpto <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt_interpto.csv", comment = "#")
A23.elecS_globaltech_shrwt <- read_csv("./inst/extdata/gcam-china/A23.elecS_globaltech_shrwt.csv", comment = "#")
A23.elecS_globalinttech_shrwt <- read_csv("./inst/extdata/gcam-china/A23.elecS_globalinttech_shrwt.csv", comment = "#")
A23.elecS_tech_mapping <- read_csv("./inst/extdata/gcam-china/A23.elecS_tech_mapping.csv", comment = "#")
A23.elecS_inttech_mapping <- read_csv("./inst/extdata/gcam-china/A23.elecS_inttech_mapping.csv", comment = "#")
A23.elecS_tech_availability <- read_csv("./inst/extdata/gcam-china/A23.elecS_tech_availability.csv", comment = "#")
L113.elecS_globaltech_capital_battery_ATB <- read_csv("./outputs/L113.elecS_globaltech_capital_battery_ATB.csv", comment = "#")
A23.elecS_stubtech_energy_inputs <- read_csv("./inst/extdata/gcam-china/A23.elecS_stubtech_energy_inputs.csv", comment = "#")
A23.elecS_subsector_shrwt_province_adj <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt_province_adj.csv", comment = "#")
A23.elecS_subsector_shrwt_interp_province_adj <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt_interp_province_adj.csv", comment = "#")
A23.elecS_subsector_shrwt_interpto_province_adj <- read_csv("./inst/extdata/gcam-china/A23.elecS_subsector_shrwt_interpto_province_adj.csv", comment = "#")

# replace the original NREL_us_re_technical_potential table to obtain no geothermal provinces
L1231.out_EJ_province_elec_F_tech <- read_csv("./outputs/L1231.out_EJ_province_elec_F_tech.csv", comment = "#")

elecS_time_fraction <- read_csv("./inst/extdata/gcam-china/elecS_time_fraction.csv", comment = "#")
A10.renewable_resource_delete <- read_csv("./inst/extdata/gcam-china/A10.renewable_resource_delete.csv", comment = "#")
L119.CapFacScaler_CSP_province <- read_csv("./outputs/L119.CapFacScaler_CSP_province.csv", comment = "#")
L1239.province_elec_supply_CHINA <- read_csv("./outputs/L1239.province_elec_supply_CHINA.csv", comment = "#")

L223.StubTechEff_elec_CHINA <- read_csv("./outputs/L223.StubTechEff_elec_CHINA.csv", comment = "#")
L223.StubTechMarket_elec_CHINA <- read_csv("./outputs/L223.StubTechMarket_elec_CHINA.csv", comment = "#")
L223.StubTechProd_elec_CHINA <- read_csv("./outputs/L223.StubTechProd_elec_CHINA.csv", comment = "#")
L223.StubTechFixOut_elec_CHINA <- read_csv("./outputs/L223.StubTechFixOut_elec_CHINA.csv", comment = "#")
L223.StubTechFixOut_hydro_CHINA <- read_csv("./outputs/L223.StubTechFixOut_hydro_CHINA.csv", comment = "#")
L223.StubTechMarket_backup_CHINA <- read_csv("./outputs/L223.StubTechMarket_backup_CHINA.csv", comment = "#")
L223.StubTechCapFactor_elec_wind_CHINA <- read_csv("./outputs/L223.StubTechCapFactor_elec_wind_CHINA.csv", comment = "#")
L223.StubTechCapFactor_elec_solar_CHINA <- read_csv("./outputs/L223.StubTechCapFactor_elec_solar_CHINA.csv", comment = "#")
L223.GlobalTechCapFac_elec <- read_csv("./outputs/L223.GlobalTechCapFac_elec.csv", comment = "#")
L223.GlobalTechCapital_elec <- read_csv("./outputs/L223.GlobalTechCapital_elec.csv", comment = "#")
L223.GlobalIntTechCapital_elec <- read_csv("./outputs/L223.GlobalIntTechCapital_elec.csv", comment = "#")
L123.eff_R_elec_F_Yh <- read_csv("./outputs/L123.eff_R_elec_F_Yh.csv", comment = "#")
L223.GlobalTechEff_elec <- read_csv("./outputs/L223.GlobalTechEff_elec.csv", comment = "#")
L223.GlobalIntTechEff_elec <- read_csv("./outputs/L223.GlobalIntTechEff_elec.csv", comment = "#")
L223.GlobalTechLifetime_elec <- read_csv("./outputs/L223.GlobalTechLifetime_elec.csv", comment = "#")
L223.GlobalIntTechLifetime_elec <- read_csv("./outputs/L223.GlobalIntTechLifetime_elec.csv", comment = "#")
L223.GlobalTechOMfixed_elec <- read_csv("./outputs/L223.GlobalTechOMfixed_elec.csv", comment = "#")
L223.GlobalIntTechOMfixed_elec <- read_csv("./outputs/L223.GlobalIntTechOMfixed_elec.csv", comment = "#")
L223.GlobalTechOMvar_elec <- read_csv("./outputs/L223.GlobalTechOMvar_elec.csv", comment = "#")
L223.GlobalIntTechOMvar_elec <- read_csv("./outputs/L223.GlobalIntTechOMvar_elec.csv", comment = "#")
L223.GlobalTechSCurve_elec <- read_csv("./outputs/L223.GlobalTechSCurve_elec.csv", comment = "#")
L223.GlobalTechProfitShutdown_elec <- read_csv("./outputs/L223.GlobalTechProfitShutdown_elec.csv", comment = "#")
L223.GlobalTechCapture_elec <- read_csv("./outputs/L223.GlobalTechCapture_elec.csv", comment = "#")
L223.GlobalIntTechBackup_elec <- read_csv("./outputs/L223.GlobalIntTechBackup_elec.csv", comment = "#")
L223.PrimaryRenewKeyword_elec <- read_csv("./outputs/L223.PrimaryRenewKeyword_elec.csv", comment = "#")
L223.PrimaryRenewKeywordInt_elec <- read_csv("./outputs/L223.PrimaryRenewKeywordInt_elec.csv", comment = "#")
L223.AvgFossilEffKeyword_elec <- read_csv("./outputs/L223.AvgFossilEffKeyword_elec.csv", comment = "#")
