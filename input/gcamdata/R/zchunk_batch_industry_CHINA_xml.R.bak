...
module_gcamchina_batch_industry_CHINA_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L232.DeleteSupplysector_CHINAind <- get_data(all_data, "L232.DeleteSupplysector_CHINAind", strip_attributes = T)
    L232.DeleteFinalDemand_CHINAind <- get_data(all_data, "L232.DeleteFinalDemand_CHINAind", strip_attributes = T)
    L232.Production_reg_imp_CHINA <- get_data(all_data, "L232.Production_reg_imp_CHINA", strip_attributes = T)
    L232.StubTechCalInput_indenergy_CHINA <- get_data(all_data, "L232.StubTechCalInput_indenergy_CHINA", strip_attributes = T)
    L232.StubTechCalInput_indfeed_CHINA <- get_data(all_data, "L232.StubTechCalInput_indfeed_CHINA", strip_attributes = T)
    L232.StubTechProd_industry_CHINA <- get_data(all_data, "L232.StubTechProd_industry_CHINA", strip_attributes = T)
    L232.StubTechCoef_industry_CHINA <- get_data(all_data, "L232.StubTechCoef_industry_CHINA", strip_attributes = T)
    L232.StubTechMarket_ind_CHINA <- get_data(all_data, "L232.StubTechMarket_ind_CHINA", strip_attributes = T)
    L232.StubTechSecMarket_ind_CHINA <- get_data(all_data, "L232.StubTechSecMarket_ind_CHINA", strip_attributes = T)
    L232.BaseService_ind_CHINA <- get_data(all_data, "L232.BaseService_ind_CHINA", strip_attributes = T)
    L232.DeleteSubsector_ind_CHINA <- get_data(all_data, "L232.DeleteSubsector_ind_CHINA", strip_attributes = T)
    L232.Supplysector_ind_CHINA <- get_data(all_data, "L232.Supplysector_ind_CHINA", strip_attributes = T)
    L232.FinalEnergyKeyword_ind_CHINA <- get_data(all_data, "L232.FinalEnergyKeyword_ind_CHINA", strip_attributes = T)
    L232.SubsectorLogit_ind_CHINA <- get_data(all_data, "L232.SubsectorLogit_ind_CHINA", strip_attributes = T)
    L232.SubsectorShrwtFllt_ind_CHINA <- get_data(all_data, "L232.SubsectorShrwtFllt_ind_CHINA", strip_attributes = T)
    L232.SubsectorInterp_ind_CHINA <- get_data(all_data, "L232.SubsectorInterp_ind_CHINA", strip_attributes = T)
    L232.StubTech_ind_CHINA <- get_data(all_data, "L232.StubTech_ind_CHINA", strip_attributes = T)
    L232.StubTechInterp_ind_CHINA <- get_data(all_data, "L232.StubTechInterp_ind_CHINA", strip_attributes = T)
    L232.PerCapitaBased_ind_CHINA <- get_data(all_data, "L232.PerCapitaBased_ind_CHINA", strip_attributes = T)
    L232.PriceElasticity_ind_CHINA <- get_data(all_data, "L232.PriceElasticity_ind_CHINA", strip_attributes = T)
    L232.IncomeElasticity_ind_gcam3_CHINA <- get_data(all_data, "L232.IncomeElasticity_ind_gcam3_CHINA", strip_attributes = T)
    L232.DeleteSupplysector_CHINAind <- get_data(all_data, "L232.DeleteSupplysector_CHINAind", strip_attributes = T)
	  L232.DeleteFinalDemand_CHINAind <- get_data(all_data, "L232.DeleteFinalDemand_CHINAind", strip_attributes = T)
