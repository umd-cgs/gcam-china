...
module_energy_L232.other_industry <- function(command, ...) {
  ...
  INCOME_ELASTICITY_OUTPUTS <- c("GCAM3",paste0("SSP", 1:5))
  ...
  if(command == driver.DECLARE_INPUTS) {
    ...
    has_district_heat <- sector <- fuel <- supplysector <- subsector <-
      ...
      L232.IncomeElasticity_ind_ssp1 <-
    ...
    # Extract GCAM3,SSP scenario data and assign to separate tables
    ...
    return_data(L232.Supplysector_ind, L232.SubsectorLogit_ind, L232.FinalEnergyKeyword_ind,
                ...
                L232.PriceElasticity_ind, L232.BaseService_ind, L232.GlobalTechShutdown_en, L232.IncomeElasticity_ind_gcam3,
