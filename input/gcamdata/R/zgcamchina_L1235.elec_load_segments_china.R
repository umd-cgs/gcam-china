...
#' module_gcamchina_L1235.elec_load_segments
#'
...
module_gcamchina_L1235.elec_load_segments <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "gcam-china/elecS_demand_fraction",
             FILE = "gcam-china/elecS_time_fraction",
             FILE = "gcam-china/elecS_fuel_fraction",
             FILE = "gcam-china/elecS_horizontal_to_vertical_map",
             "L1234.out_EJ_grid_elec_F_CHINA"))
  } else if(command == driver.DECLARE_OUTPUTS) {
    return(c("L1235.grid_elec_supply_CHINA",
    ...
    grid_region <- grid.region <- year <- sector <- segment <- horizontal_segment <- vertical_segment <-
    ...
    elecS_demand_fraction <- get_data(all_data, "gcam-china/elecS_demand_fraction", strip_attributes = TRUE)
    elecS_time_fraction <- get_data(all_data, "gcam-china/elecS_time_fraction", strip_attributes = TRUE)
    elecS_fuel_fraction <- get_data(all_data, "gcam-china/elecS_fuel_fraction", strip_attributes = TRUE)
    elecS_horizontal_to_vertical_map <- get_data(all_data, "gcam-china/elecS_horizontal_to_vertical_map", strip_attributes = TRUE)
    L1234.out_EJ_grid_elec_F <- get_data(all_data, "L1234.out_EJ_grid_elec_F_CHINA", strip_attributes = TRUE)
    ...
    elecS_horizontal_vertical_base %>%
      ...
      select(grid_region, horizontal_segment, off.peak.electricity = off.peak.electricity.time,
             ...
             peak.electricity = peak.electricity.time) %>%
      group_by(grid_region,horizontal_segment) %>%
    ...
    elecS_horizontal_vertical_GCAM_coeff_base %>%
      ...
      select(grid_region, horizontal_segment, off.peak.electricity, intermediate.electricity,
             subpeak.electricity, peak.electricity) -> L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA
    ...
    L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA %>%
      ...
      rename(off.peak.electricity.tot = off.peak.electricity,
             ...
             peak.electricity.tot = peak.electricity) -> L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA_tot

    L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA %>%
      left_join_error_no_match(L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA_tot, by = "grid_region") %>%
      ...
      arrange(grid_region) -> L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA

    # Check for negative coefficients.
    stopifnot(all(L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA$coefficient >= 0))
    ...
    L1235.grid_elec_supply_CHINA %>%
      ...
      add_legacy_name("L1235.grid_elec_supply_CHINA") %>%
      add_precursors("L1234.out_EJ_grid_elec_F_CHINA",
                     "gcam-china/elecS_fuel_fraction") ->
      L1235.grid_elec_supply_CHINA
    ...
    L1235.elecS_horizontal_vertical_CHINA %>%
      ...
      add_legacy_name("L1235.elecS_horizontal_vertical_CHINA") %>%
      add_precursors("gcam-china/elecS_time_fraction",
    ...
    L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA %>%
      ...
      add_legacy_name("L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA") %>%
      add_precursors("gcam-china/elecS_demand_fraction",
    ...
    L1235.elecS_demand_fraction_CHINA %>%
      ...
      add_legacy_name("L1235.elecS_demand_fraction_CHINA") %>%
      add_precursors("gcam-china/elecS_demand_fraction") ->
      L1235.elecS_demand_fraction_CHINA

    return_data(L1235.grid_elec_supply_CHINA,
                L1235.elecS_horizontal_vertical_CHINA,
                L1235.elecS_horizontal_vertical_GCAM_coeff_CHINA,
                L1235.elecS_demand_fraction_CHINA)
  } else {
