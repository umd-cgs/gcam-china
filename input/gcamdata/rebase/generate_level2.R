...
generate_level2_data_names <- function() {
  ...
  level2_data_names[["SubsectorInterpTo_overwrite"]] <- c(level2_data_names[["SubsectorInterpTo"]], "warn", "overwrite.policy")
  ...
  level2_data_names[["GlobalTranTechInterp_overwrite"]] <- c(level2_data_names[["GlobalTranTechInterp"]], "overwrite.policy")
