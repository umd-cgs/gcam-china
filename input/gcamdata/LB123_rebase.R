...
CPSY_GWh_province_F_elec_out <- read_csv("./inst/extdata/gcam-china/CPSY_GWh_province_F_elec_out.csv", comment = "#")

L101.inNBS_Mtce_province_S_F <- read_csv("./outputs/L101.inNBS_Mtce_province_S_F.csv", comment = "#")
L123.in_EJ_R_elec_F_Yh <- read_csv("./outputs/L123.in_EJ_R_elec_F_Yh.csv", comment = "#")
L123.out_EJ_R_elec_F_Yh <- read_csv("./outputs/L123.out_EJ_R_elec_F_Yh.csv", comment = "#")
L126.in_EJ_R_elecownuse_F_Yh <- read_csv("./outputs/L126.in_EJ_R_elecownuse_F_Yh.csv", comment = "#")
L126.out_EJ_R_elecownuse_F_Yh <- read_csv("./outputs/L126.out_EJ_R_elecownuse_F_Yh.csv", comment = "#")
L132.out_EJ_province_indchp_F <- read_csv("./outputs/L132.out_EJ_province_indchp_F.csv", comment = "#")
