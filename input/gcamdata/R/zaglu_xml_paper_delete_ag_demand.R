...
module_aglu_paper_delete_ag_demand_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    return(c(XML = "paper_delete_ag_demand.xml",
             ...
             XML = "paper_delete_ag_demand_China.xml"))
    ...
    create_xml("paper_delete_ag_demand_China.xml") %>%
      ...
      add_precursors("L2327.DeleteSupplysector_PaperAgDemand",
                     "L2327.DeleteFinalDemand_PaperAgDemand") ->
      paper_delete_ag_demand_China.xml

    return_data(paper_delete_ag_demand.xml, paper_delete_ag_demand_USA.xml,paper_delete_ag_demand_China.xml)
  } else {
