...
#' module_gcamchina_transportation_xml
#'
...
module_gcamchina_transportation_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L254.StubTechTrackCapital_CHINA<- get_data(all_data, "L254.StubTechTrackCapital_CHINA")
    ...
    create_xml("transportation_CHINA.xml") %>%
      ...
      #add_xml_data(L254.StubTechTrackCapital_CHINA, "StubTechTrackCapital") %>%
