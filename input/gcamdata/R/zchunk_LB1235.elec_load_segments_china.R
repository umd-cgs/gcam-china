...
#' module_gcamchina_LB1235.elec_load_segments_china
#'
...
module_gcamchina_LB1235.elec_load_segments_china <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    elecS_horizontal_vertical_base %>%
      ...
      select(grid_region, horizontal_segment, off.peak.electricity = off.peak.electricity.time,
             ...
             peak.electricity = peak.electricity.time)-> L1235.elecS_horizontal_vertical_CHINA
