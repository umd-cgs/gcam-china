...
module_gcamchina_hydrogen_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L225.Supplysector_h2_ind_CHINA <- get_data(all_data, "L225.Supplysector_h2_ind_CHINA")
    L225.SubsectorLogit_h2_ind_CHINA <- get_data(all_data, "L225.SubsectorLogit_h2_ind_CHINA")
    L225.SubsectorShrwtFllt_h2_ind_CHINA <- get_data(all_data, "L225.SubsectorShrwtFllt_h2_ind_CHINA")
    L225.TechCoef_h2_ind_CHINA <- get_data(all_data, "L225.TechCoef_h2_ind_CHINA")
    L225.TechShrwt_h2_ind_CHINA <- get_data(all_data, "L225.TechShrwt_h2_ind_CHINA")
    L225.DeleteStubTechMinicamEnergyInput_H2_CHINA <- get_data(all_data, "L225.DeleteStubTechMinicamEnergyInput_H2_CHINA")
    # ===================================================
    ...
    create_xml("hydrogen_CHINA.xml") %>%
      ...
      #add_logit_tables_xml(L225.Supplysector_h2_ind_CHINA, "Supplysector") %>%
      ...
      #add_logit_tables_xml(L225.SubsectorLogit_h2_ind_CHINA, "SubsectorLogit") %>%
      add_xml_data(L225.SubsectorShrwtFllt_h2_CHINA, "SubsectorShrwtFllt") %>%
      #add_xml_data(L225.SubsectorShrwtFllt_h2_ind_CHINA, "SubsectorShrwtFllt") %>%
      add_xml_data(L225.StubTech_h2_CHINA, "StubTech") %>%
      add_xml_data(L225.StubTechMarket_h2_CHINA, "StubTechMarket") %>%
      add_xml_data(L225.DeleteStubTechMinicamEnergyInput_H2_CHINA,"DeleteStubTechMinicamEnergyInput") %>%
      #add_xml_data(L225.TechCoef_h2_ind_CHINA,"TechCoef") %>%
      #add_xml_data(L225.TechShrwt_h2_ind_CHINA,"TechShrwt") %>%
