...
module_gcamchina_L224_China.heat <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L224.StubTechCalInput_heat_china %>%
      ...
      add_precursors("L124.in_EJ_R_heat_F_Yh","L144.in_EJ_province_bld_F_U","L132.in_EJ_province_indnochp_F", "energy/calibrated_techs", "energy/A_regions", "common/GCAM_region_names") ->
      L224.StubTechCalInput_heat_china
    ...
    L224.StubTechSecOut_elec_china %>%
      ...
      add_precursors("L1231.out_EJ_province_elec_F_tech","L124.out_EJ_R_heatfromelec_F_Yh", "energy/calibrated_techs", "energy/A24.sector") ->
      L224.StubTechSecOut_elec_china
    ...
    L224.StubTechCost_elec_china %>%
      ...
      add_precursors("L1231.out_EJ_province_elec_F_tech","L1231.eff_R_elec_F_tech_Yh", "energy/calibrated_techs", "energy/A24.sector", "energy/A_regions") ->
      L224.StubTechCost_elec_china
    ...
    return_data(L224.Supplysector_heat_china, L224.SubsectorLogit_heat_china, L224.SubsectorShrwt_heat_china, L224.SubsectorShrwtFllt_heat_china,
                L224.SubsectorInterp_heat_china, L224.SubsectorInterpTo_heat_china, L224.StubTech_heat_china, L224.StubTechCalInput_heat_china, L224.StubTechSecOut_elec_china, L224.StubTechCost_elec_china,L224.DeleteSupplysector_CHINAheat,L224.StubTechMarket_heat_CHINA)
  } else {
